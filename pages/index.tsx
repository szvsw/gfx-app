  ...
  <>
    <Grid sx={{mt: "1rem"}} spacing={1} container>
      ...
      <Stack spacing="0.5rem">
        <Typography variant="caption" >Welcome to IGS.  This website will allow you to explore the reciprocal relation between primal and dual representations of the forms and forces in a few common structural topologies.</Typography>
        ...
        <Typography variant="caption" >Thank you to John Ochsendorf and Moh Ismail for their wonderful sources of inspiration.</Typography>
